      ...
      <div className='page-paner'>
        <Box sx={{ justifyContent: 'center' }}>
          ...
          <Breadcrumbs sx={{ color: '#fffff', display: 'flex', justifyContent: 'center' }}  >
            <Link style={{ textDecoration: 'none', color: "#ffffff" }} to={`/blogs/danh-gia-xe`}>
    ...
    <>
      <Box>
        ...
        <Grid marginTop={0} container spacing={3}>
          <Grid item xs={6}>
            <img src='/xedien.webp' style={{ width: '100%', height: '280' }} />
          </Grid>
          <Grid item xs={6}>
            ...
            <Typography variant='body2' marginTop={3} >
              Với mong muốn ôtô điện Wuling HongGuang MiniEV đánh gục các mẫu xe tay ga phân khúc cao cấp từ 200 triệu đồng trở xuống. Liệu mẫu xe có đánh bại được các đối thủ, cùng Thái Công Auto phân...            </Typography>
          </Grid>
        </Grid>
